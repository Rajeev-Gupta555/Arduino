...
void setup() {
  ...
  Serial.println("==========================");
  scale.set_scale(1.0f);        // this value is obtained by calibrating the scale with known weights; see the README for details
  scale.tare(value_double);               // reset the scale to 0
